...
Development of the code is done through so called *Pull Requests* (PR) on [github](https://github.com/mong/tmongr).
...
roxygen2::roxygenise()
```
5. Build the documentation (to see if it looks ok). This is also done by [Travis CI](https://travis-ci.org/mong/tmongr/builds) after pushing to the master branch on [github](https://github.com/mong/tmongr).
```
pkgdown::build_site()
```
6. Test the package
...
9. Draft a new release on [github](https://github.com/mong/tmongr/releases/new)
