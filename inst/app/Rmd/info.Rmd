...
- Hvis man opplever feil eller problemer kan man rapportere dette som en *issue* [her](https://github.com/mong/tmongr/issues). Eventuelt kan man sende en mail til arnfinn.steindal@skde.no

Versjon `r installed.packages()["tmongr", 3]` av [tmongr](https://github.com/mong/tmongr).

Tidligere versjoner av nettside:

- [16.12.2019](https://skde.shinyapps.io/tabellverk_2019_12_16/)
