...
- Bakgrunnstallene er hentet fra sykehusoppholdsfiler fra NPR og er aggregert på ulike nivå.
  - **Sykehusopphold**: Opphold som er kodet som døgnopphold eller dagbehandlings *ved samme sykehus* som har foregått nært i tid eller samtidig regnes som ett opphold. Nært i tid er mindre enn åtte timer mellom utskrivelse fra ett opphold til innskrivelse til et nytt opphold. Antall DRG-poeng hentes fra det bærende oppholdet, som er det oppholdet med høyest DRG-poeng. Polikliniske konsultasjoner regnes som kontakter, uavhengig av nærhet i tid til andre kontakter. Polikliniske kontakter under et døgnopphold eller dagbehandling er ikke inkludert i sykehusoppholdsfiler fra NPR og vises dermed ikke her.
  - **Justert for overføringer**: Ved justering for overføringer er alle døgn- og dagopphold med mindre enn åtte timer mellom utskrivelse fra ett opphold til innskrivelse til neste opphold regnet som ett opphold, *uavhengig av hvor pasienten er behandlet*. Liggetiden regnes som tiden fra innskrivelse ved første opphold til utskrivelse fra siste opphold. Behandlingssted og antall DRG-poeng hentes fra det bærende oppholdet, som er det oppholdet med høyest DRG-poeng. Polikliniske kontakter under et døgnopphold eller dagbehandling er ikke inkludert i sykehusoppholdsfiler fra NPR og vises dermed ikke her.
